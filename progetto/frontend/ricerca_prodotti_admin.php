...
<?php
    ...
    $_SESSION["page"]="ricerca_prodotti_admin";
...
<body class='bg-image'>
    ...
    <?php if (isset($_SESSION['elimina_success'])) {
        ?>
    ...
    <?php if(isset($errore_elimina["msg"])) {?> 
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <?php } else { ?>
                                    <li class="list-group-item">
                                        Prezzo: 
                                        <span class="text-decoration-line-through  me-2"><?= number_format($item['prezzo'], 2, ',', '.'); ?>€</span>
                                        <span class="fw-bold "><?= number_format(($item['prezzo'] * (100 - $item['sconto'])) / 100, 2, ',', '.'); ?>€</span>
                                        <span class="badge bg-success">-<?= $item['sconto']; ?>%</span>
                                    </li>
                                <?php } ?>
                                <li class="list-group-item">Categoria: <?= $item['categoria']; ?></li>
                                <li class="list-group-item">Artista: <?= $item['artista']; ?></li>
                            </ul>
                            <div class="card-body d-flex center-content-center gap-2">
                                ...
                                <div class="text-center mt-2">
                                    <button type="button" class="btn btn-viola btn-commenti" data-bs-toggle="modal" data-bs-target="#commentiModal" data-prodotto-id="<?= $item['id_prodotto']; ?>">Commenti</button>
                                </div>
                            </div>
                        </div>
                    </div>
